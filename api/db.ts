...
const MOCK_SITE_SETTINGS: SiteSettings = {
    ...
    faq: [
        { id: "faq-1", question: "Comment fonctionne le rachat de véhicule ?", answer: "Vous nous contactez via le formulaire dédié ou par téléphone. Nous évaluons votre véhicule et vous faisons une proposition." },
    ],
    footer: {
    ...
    pageContent: {
        ...
        removal: { heroTitle: "Enlèvement d'épaves", heroSubtitle: "Service d'enlèvement d'épave gratuit en Normandie.", heroImage: "https://picsum.photos/seed/tow-truck/1920/1080", contentTitle: "Libérez-vous de votre épave", contentDescription: "Nous intervenons rapidement pour l'enlèvement de votre véhicule hors d'usage.", contentImage: "https://picsum.photos/seed/scrap-yard/800/600", features: [ "<strong>Enlèvement gratuit</strong>", "<strong>Intervention rapide</strong>", "<strong>Formalités administratives incluses</strong>" ] },
        parts: { heroTitle: "Catalogue de Pièces", heroSubtitle: "Trouvez la pièce parfaite pour votre véhicule.", heroImage: "https://picsum.photos/seed/parts-hero/1920/1080", contentTitle: "Un large choix de pièces", contentDescription: "Toutes nos pièces sont démontées, testées et garanties.", contentImage: "https://picsum.photos/seed/parts-stock/800/600", features: [ "<strong>Pièces garanties</strong>", "<strong>Testées par nos experts</strong>", "<strong>Prix attractifs</strong>" ] },
        buyback: { heroTitle: "Rachat de Véhicule", heroSubtitle: "Obtenez une offre gratuite pour votre voiture.", heroImage: "https://picsum.photos/seed/buyback-hero/1920/1080", contentTitle: "Vendez votre véhicule simplement", contentDescription: "Nous rachetons tous types de véhicules, quel que soit leur état.", contentImage: "https://picsum.photos/seed/car-cash/800/600", features: [ "<strong>Estimation gratuite</strong>", "<strong>Paiement immédiat</strong>", "<strong>Pas de contrôle technique requis</strong>" ] },
        windshield: { heroTitle: "Remplacement & Réparation de Pare-Brise", heroSubtitle: "Visibilité et sécurité maximales.", heroImage: "https://picsum.photos/seed/windshield-bg/1920/1080", contentTitle: "Un service complet pour votre visibilité", contentDescription: "Nous évaluons rapidement les dommages et proposons la meilleure solution.", contentImage: "https://picsum.photos/seed/windshield-repair/800/600", features: [ "<strong>Réparation d'impact</strong>", "<strong>Remplacement de Pare-Brise</strong>", "<strong>Compatible toutes assurances</strong>" ] },
        lift: { heroTitle: "Location de Pont Élévateur", heroSubtitle: "Travaillez sur votre véhicule comme un pro.", heroImage: "https://picsum.photos/seed/lift-rental/1920/1080", contentTitle: "Un atelier tout équipé", contentDescription: "Louez un pont et profitez de notre outillage professionnel.", contentImage: "https://picsum.photos/seed/garage-workshop/800/600", features: [ "<strong>Ponts professionnels</strong>", "<strong>Outillage disponible</strong>", "<strong>Conseils de pros</strong>" ] },
    },
    advancedSettings: {
