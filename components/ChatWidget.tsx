...
export default function ChatWidget(): React.ReactNode {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-5 w-80 h-[450px] bg-white rounded-lg shadow-2xl z-50 flex flex-col transition-all duration-300 ease-out origin-bottom-right transform scale-100">
