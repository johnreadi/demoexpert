...
import { Product, Auction, PartCategory, User, AdminMessage, SiteSettings, LiftRentalBooking, AuditLogEntry, Contact, ServicePageSettings, ServiceInfo, Testimonial, FooterLink } from '../types';
